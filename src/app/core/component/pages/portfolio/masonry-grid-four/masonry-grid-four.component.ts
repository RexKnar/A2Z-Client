...
@Component({
  selector: 'app-masonry-grid-four',
  templateUrl: './masonry-grid-four.component.html',
  styleUrls: ['./masonry-grid-four.component.scss']
})
export class MasonryGridFourComponent implements OnInit, AfterViewInit  {
